...
@app.on_message(filters.command(AUTHORIZE_COMMAND,None) & SUDOERS)
@language
...
@app.on_message(filters.command(UNAUTHORIZE_COMMAND,None) & SUDOERS)
@language
...
@app.on_message(filters.command(AUTHORIZED_COMMAND,None) & SUDOERS)
@language
