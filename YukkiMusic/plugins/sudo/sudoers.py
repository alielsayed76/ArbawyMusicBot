...
@app.on_message(
    filters.command(ADDSUDO_COMMAND,None) & filters.user(OWNER_ID)
)
@language
...
@app.on_message(
    filters.command(DELSUDO_COMMAND,None) & filters.user(OWNER_ID)
)
@language
...
@app.on_message(filters.command(SUDOUSERS_COMMAND,None) & ~BANNED_USERS)
@language
