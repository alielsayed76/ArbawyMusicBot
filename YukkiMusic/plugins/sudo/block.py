...
@app.on_message(filters.command(BLOCK_COMMAND,None) & SUDOERS)
@language
...
@app.on_message(filters.command(UNBLOCK_COMMAND,None) & SUDOERS)
@language
...
@app.on_message(filters.command(BLOCKED_COMMAND,None) & SUDOERS)
@language
